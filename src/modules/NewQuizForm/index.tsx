                        ...
                        {categories.isSuccess &&
                            filteredCategories.map(category => (
                                <div
                                    ...
                                    className={clsx("flex justify-center items-center text-lg  text-light border-light rounded-md", { "bg-light/30": quizData.categoryId === category.id, "bg-light/10": quizData.categoryId !== category.id })}
                                >
